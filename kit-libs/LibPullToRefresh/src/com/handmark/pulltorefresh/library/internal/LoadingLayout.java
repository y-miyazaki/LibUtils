    ...
    public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
        ...
        default:
            if (mode == Mode.PULL_FROM_START) {
                LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header_vertical_header, this);
            } else {
                LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header_vertical_footer, this);
            }
            break;
        }
