...
public class NetworkResponse {
    ...
    public NetworkResponse(int statusCode, byte[] data, Map<String, String> headers,
            boolean notModified) {
        // y-miyazaki bugfix start
        this(statusCode, data, headers, notModified, 0, null);
        // y-miyazaki bugfix end
    }

    public NetworkResponse(byte[] data) {
        // y-miyazaki bugfix start
        this(HttpStatus.SC_OK, data, Collections.<String, String> emptyMap(), false, 0, null);
        // y-miyazaki bugfix end
    }

    public NetworkResponse(byte[] data, Map<String, String> headers) {
        // y-miyazaki bugfix start
        this(HttpStatus.SC_OK, data, headers, false, 0, null);
        // y-miyazaki bugfix end
    }
